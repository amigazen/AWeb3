 ...
 *
 * It is included in startup.c to import project specific
 * constants.
 *
...
#define PLUGIN_LIBNAME     "awebwebp.awebplugin"
#define PLUGIN_LIBID       "awebwebp 1.0 " __AMIGADATE__
#define PLUGIN_SIZE        sizeof(struct AwebWebpBase)
