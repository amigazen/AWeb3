...
/* MARQUEE attribute tags disabled (reserved slot range kept for binary compatibility)
#define AOBDY_MarqueeDirection (AOBDY_Dummy+68)
#define AOBDY_MarqueeBehavior (AOBDY_Dummy+69)
#define AOBDY_MarqueeScrollAmount (AOBDY_Dummy+70)
#define AOBDY_MarqueeScrollDelay (AOBDY_Dummy+71)
#define AOBDY_MarqueeLoop (AOBDY_Dummy+72)
#define AOBDY_MarqueeScrollX (AOBDY_Dummy+73)
#define AOBDY_MarqueeScrollY (AOBDY_Dummy+74)
*/
